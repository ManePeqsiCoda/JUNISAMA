...
| 5 | **ISO 14001** | "Cumplimos estandares internacionales" | Badge dorado, certificacion visible, confianza institucional |
...
| `caption` | `0.75rem` (12px) | 500 | 1.5 | 0.08em | Labels uppercase | Badges, etiquetas de categoria, "PREMIUM", "ISO 14001" |
...
6. Stats de confianza: "500+ eventos", "24/7", "ISO 14001", "10+ anos"
...
| `gold` | `#c9a84c` | `#1b1341` | "ISO 14001", "ISO 14001", certificaciones |
