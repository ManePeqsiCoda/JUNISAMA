...
const serviceItems = [
  ...
  { name: "Planes", href: "/servicios?categoria=planes", icon: Tag, badge: "Nuevo" },
]
                      ...
                      <div className="rounded-xl border border-[var(--boga-border-subtle)] bg-[var(--boga-surface-floating)] p-4 shadow-[var(--boga-shadow-4)]">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          {link.children.map((child) => {
                            ...
                            const itemData = child as typeof child & { badge?: string }
                            return (
                              <Link
                                key={child.href}
                                href={child.href}
                              ...
                              >
                                ...
                                {child.name}
                                {itemData.badge && (
                                  <span className="ml-auto rounded-full bg-[var(--boga-lima-500)] px-1.5 py-0.5 text-[10px] font-bold text-white">
                                    {itemData.badge}
                                  </span>
                                )}
                              </Link>
