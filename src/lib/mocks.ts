...
export const productos: Producto[] = [
  {
    ...
    tipo: "PRODUCTO",
    badge: "Premium",
    imagenPrincipal: "/images/productos/bano-vip.svg",
    precioBase: 450000,
    unidadMedida: "unidad",
    destacado: true,
    orden: 1,
  ...
  },
  {
    ...
    tipo: "PRODUCTO",
    badge: "Más popular",
    imagenPrincipal: "/images/productos/bano-estandar.svg",
    precioBase: 180000,
    unidadMedida: "unidad",
    destacado: true,
    orden: 2,
  ...
  },
  {
    ...
    tipo: "PRODUCTO",
    badge: "Inclusivo",
    imagenPrincipal: "/images/productos/discapacitados.svg",
    precioBase: 320000,
    unidadMedida: "unidad",
    destacado: false,
    orden: 3,
  ...
  },
  {
    ...
    tipo: "PRODUCTO",
    badge: "Tecnología",
    imagenPrincipal: "/images/productos/electricos.svg",
    precioBase: 280000,
    unidadMedida: "unidad",
    destacado: false,
    orden: 4,
  ...
  },
  {
    ...
    tipo: "PRODUCTO",
    imagenPrincipal: "/images/productos/lavamanos.svg",
    precioBase: 150000,
    unidadMedida: "unidad",
    destacado: false,
    orden: 5,
  ...
  },
  {
    ...
    tipo: "PRODUCTO",
    badge: "Alto volumen",
    imagenPrincipal: "/images/productos/trailer-lujo.svg",
    precioBase: 2500000,
    unidadMedida: "unidad",
    destacado: true,
    orden: 6,
  ...
  },
  {
    ...
    tipo: "SERVICIO",
    imagenPrincipal: "/images/productos/operarios.svg",
    precioBase: 180000,
    unidadMedida: "turno",
    destacado: false,
    orden: 7,
  ...
  },
  {
    ...
    tipo: "PRODUCTO",
    badge: "Sostenible",
    imagenPrincipal: "/images/productos/puntos-ecologicos.svg",
    precioBase: 220000,
    unidadMedida: "unidad",
    destacado: false,
    orden: 8,
...
export const eventos: Evento[] = [
  {
    ...
    testimonio:
      "Junisama cumplió con todos los estándares de calidad y servicio. Definitivamente nuestro aliado estratégico.",
    nombreTestimonio: "Carlos Vargas",
    cargoTestimonio: "Director de Operaciones",
    estrellasTestimonio: 5,
    destacado: true,
    estado: "PUBLICADO",
  },
  {
    ...
    testimonio: "Excelente logística y puntualidad en la entrega.",
    nombreTestimonio: "María Elena Ríos",
    cargoTestimonio: "Gerente de Proyectos",
    estrellasTestimonio: 5,
    destacado: true,
    estado: "PUBLICADO",
  },
  ...
  },
  {
    ...
    testimonio: "Los baños VIP fueron un detalle que todos los invitados destacaron.",
    nombreTestimonio: "Laura Gómez",
    cargoTestimonio: "Wedding Planner",
    estrellasTestimonio: 5,
    destacado: true,
    estado: "PUBLICADO",
  },
